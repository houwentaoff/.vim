...
syn keyword        cType                __b32
" 自己加的 用于显示函数为紫色 不起作用啊,gvim启作用
...
"hi app_memman_fun guifg=#ff8c50 gui=NONE
...
hi mainFunction guifg=#1E90FF gui=NONE
"syn match hou_main_function /[ ]main[ ]/
""""""""""""""""""""""""""""""""""""""""""""""""""""""

"内存管理的函数
syn keyword app_memman_fun malloc free
hi app_memman_fun guifg=#ff8c50 gui=NONE
"syn match hou_memman_func /malloc\|free[\( ]/
"IPC
"stdio.h
"time.h
"顺序颠倒在进入的时候会提示错误 Mapping already in use:"\"<LocalLeader>is",mode 'n' ...'i'
syn keyword timeman_func sleep usleep
hi  timeman_func guifg=#7982f0 gui=NONE"
"from http://blog.csdn.net/wooin/article/details/1858917
"========================================================
